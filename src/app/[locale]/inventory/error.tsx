...
import { Button, Card, CardHeader, CardPreview, Text, Title3, makeStyles, tokens } from '@fluentui/react-components'
        ...
        <div className={styles.container}>
            <Card className={styles.card}>
                <CardHeader
                    ...
                    description={<Text>Failed to load inventory data. Please try again.</Text>}
