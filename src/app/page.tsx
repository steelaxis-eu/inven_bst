          ...
          <Link href="/inventory" className="group block">
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-6 transition-all duration-300 hover:shadow-lg hover:border-primary/20 hover:-translate-y-1">
              <div className="flex flex-col items-center justify-center text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">Manage stock levels, add new items, and check availability.</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/usage/history" className="group block">
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-6 transition-all duration-300 hover:shadow-lg hover:border-primary/20 hover:-translate-y-1">
              <div className="flex flex-col items-center justify-center text-center space-y-3">
                ...
                <h2 className="text-xl font-bold tracking-tight">Usage History</h2>
                <p className="text-sm text-muted-foreground leading-relaxed">View complete history of all material usage and scraps.</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/projects" className="group block">
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-6 transition-all duration-300 hover:shadow-lg hover:border-primary/20 hover:-translate-y-1">
              <div className="flex flex-col items-center justify-center text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">Organize work into projects and track assignments.</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/stock" className="group block">
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-6 transition-all duration-300 hover:shadow-lg hover:border-primary/20 hover:-translate-y-1">
              <div className="flex flex-col items-center justify-center text-center space-y-3">
                ...
                <h2 className="text-xl font-bold tracking-tight">Search Stock</h2>
                <p className="text-sm text-muted-foreground leading-relaxed">Quickly find specific profiles across inventory.</p>
              </div>
            </div>
          </Link>
